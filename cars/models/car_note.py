...
class CarNotePhoto(models.Model):
    ...
    car_note = models.ForeignKey(
        CarNote, on_delete=models.CASCADE, to_field="id", related_name="car_note_photo"
    )
    ...
    def get_absolute_url(self):
        return reverse("cars:delete-note-photo", kwargs={"pk": self.pk})
